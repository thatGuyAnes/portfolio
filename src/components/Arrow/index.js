    ...
    <div className="c-arrow-container">
      <div className="c-arrow">
        ...
        <span className="c-arrow_text_wrapper">
          <span className="c-arrow_special o-special-container">
            <Swiggly />
            <Scroll />
            skroll{" "}
          </span>
